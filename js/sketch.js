...
function preload() {
  titleScreen = loadImage('./images/angry_pumpkins.jpg');
  imgSkull = loadImage('./images/skull.png');
  pumpkinImg = loadImage('./images/angry2.png');
  imgBoxSkull = loadImage('./images/box2.png');
  imgStone1 = loadImage('./images/stone2.png');
  imgBone1 = loadImage('./images/bone1.png');
  imgPlank1 = loadImage('./images/plank1.png');
